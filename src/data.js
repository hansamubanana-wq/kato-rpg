...
export const SAVE_KEY = 'kato_rpg_save_v5'; // ステージ構成が変わるためバージョンアップ
...
export const ARTS = {
  ...
  // 菅原先生（太ってる眼鏡パーマ）：横に広い、髪がもじゃもじゃ(6)、眼鏡(0-0)
...
export const STAGES = [
  ...
  { id: 6, name: '菅原先生', hp: 1400, atk: 35, exp: 150, gold: 400, key: 'sugawara' }, // 太めなのでHP高め
